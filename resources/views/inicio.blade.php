		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Más Pagina <b class="caret"></b></a>
...
<main id="main">
	...
	<div class="container">
		...
		<div class="row section topspace">
			<div class="col-md-12">
				<p class="lead text-center text-muted">Venezolano Ingeniero en Informática, Especialista en programación en PHP, JavaScript, CSS, HTML, Ajax, Laravel. - Buen manejo en Base de Datos: MySQL y PostgreSQL, MariaDB. - Manejo de herramientas como: Joomla, Wordpress.
				- Reparación de Equipos informáticos. </p>
			</div>
		</div> <!-- / section -->
		...
		<div class="row section featured topspace">
			...
			<div class="row">
				<div class="col-sm-6 col-md-3">
					<h3 class="text-center">Desarrollo de Aplicaciones Web.</h3>
					<p>Desarrollo todo tipo de aplicación basado en php7, javascript, Boostrap</p>
				...
				<div class="col-sm-6 col-md-3">
					<h3 class="text-center">Adiestramiento.</h3>
					<p>I don't think they tried to market it to the billionaire, spelunking, base-jumping crowd. i did the same thing to gandhi, he didn't eat for three weeks. i once heard a wise man say there are no perfect men.</p>
					<p class="text-center"><a href="" class="btn btn-action">Read more</a></p>
				</div>
			</div>
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="assets/images/logochacao.jpg" alt="" height="100%" width="100%">
							<span class="cover"><span class="more">See details &rarr;</span></span>
						</span>
						<span class="title">Sistema de Información Deporte</span>
					</a>
					<span class="details"><a href="http://localhost/sid/principal.php" target="_blank">Sitio Web</a></span>
					<h4></h4>
					<p></p>
				</div>
		...
		<div class="row section clients topspace">
			<h2 class="section-title"><span>Herramientas de Usos</span></h2>
			<div class="col-lg-12">
				<p>
